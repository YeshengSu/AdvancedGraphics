...
Particle* ParticleEmitter::GetFreeParticle()	{
	...
	p->position.ToZero();
	p->position.x += ((RAND() - RAND()) * particleVariance);
	p->position.y += ((RAND() - RAND()) * particleVariance);
	p->position.z += ((RAND() - RAND()) * particleVariance);
...
void ParticleEmitter::Draw()	{
	...
	glUniform1f(glGetUniformLocation(material->GetShader()->GetProgram(), "particleSize"), GetParticleSize());
